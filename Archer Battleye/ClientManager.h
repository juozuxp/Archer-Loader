...
{
public:
	static bool Initialize(SOCKET ClientSocket);

	static void Disconnect();
	static void Duplicate(unsigned long ProcessID, WSAPROTOCOL_INFOA* ProtocolInfo);

	static bool Send(ArcherType Type, void* Buffer, unsigned long Size);
...
private:
	...
	bool VerifyHash(void* Data, unsigned long Size, unsigned long long SubHash);

	unsigned long long GetDataHash(void* Data, unsigned long Size);
	unsigned long long GetDataHashOffset(void* Data, unsigned long Size);
